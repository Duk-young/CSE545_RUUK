...
output_directory = './preprocessed_by_country_bert/'
indexed_output_directory ='./preprocessed_by_country_bert_indexed/'
output_filename = ''
indexed_output_filename = ''
filename_format = 'UkraineTweetsPreprocessedByCountry'
